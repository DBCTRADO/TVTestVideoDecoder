...
static ATTR_ALIGN(16) const uint8_t default_intra_quantizer_matrix[64] = {
    8,
    16, 16,
    19, 16, 19,
    22, 22, 22, 22,
...
ATTR_ALIGN(16) uint8_t mpeg2_scan_norm[64] = {
...
ATTR_ALIGN(16) uint8_t mpeg2_scan_alt[64] = {
...
{
    mpeg2dec->user_data_len += (unsigned int)(mpeg2dec->chunk_ptr - 1 - mpeg2dec->chunk_start);
